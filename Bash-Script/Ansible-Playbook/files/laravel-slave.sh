...
sudo sed -i 's/DB_DATABASE=laravel/DB_DATABASE=ibikunle/' /var/www/html/laravel/.env

sudo sed -i 's/DB_USERNAME=root/DB_USERNAME=ibikunle/' /var/www/html/laravel/.env

sudo sed -i 's/DB_PASSWORD=/DB_PASSWORD=ibikunle009/' /var/www/html/laravel/.env
